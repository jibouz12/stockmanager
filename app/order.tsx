...
function OrderItemComponent({ 
  ...
  return (
    <View style={[
      ...
      {/* Badge pour les articles auto-générés */}
      {isAutoGenerated && (
        <View style={styles.autoGeneratedBadge}>
          <Text style={styles.autoGeneratedBadgeText}>Auto</Text>
        </View>
      )}
        ...
        <View style={styles.quantitySection}>
          {isEditing ? (
            ...
            <View style={styles.quantityContainer}>
              ...
              >
                <Minus color={isAutoGenerated ? "#D1D5DB" : "#EF4444"} size={16} />
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                disabled={isAutoGenerated}
              >
                <Plus color={isAutoGenerated ? "#D1D5DB" : "#10B981"} size={16} />
              </TouchableOpacity>
            </View>
          )}
        </View>
...
export default function OrderScreen() {
  ...
  const handleRemoveItem = async (itemId: string) => {
    ...
    Alert.alert(
      'Supprimer l\'article',
      `Êtes-vous sûr de vouloir supprimer "${item.name}" de la commande ?`,
      [
